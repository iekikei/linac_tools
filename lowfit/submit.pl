...
sub WriteScriptFile() {
    ...
    print SCRIPT "./lowfit_mc $runn /disk02/lowe8/mharada/linac/sk5/skg4/lowfit_$version/wtf_lin.${runn}.$count.root  /disk02/lowe8/mharada/linac/sk5/skg4/out_root_tune/lin.${runn}.${count}.root\n";
    close SCRIPT;
    $cmd = "chmod 755 $file";
    system $cmd;
}
